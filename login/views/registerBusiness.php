...
<html>
    ...
    <div id="regDiv">
        ...
        <form class="regForm" method="post" action="registerBusiness.php" name="businessRegisterForm">
            ...
            <input id="regUserName" class="login_input" type="text" pattern="[a-zA-Z0-9]{2,64}" name="business_name" required /><BR/><BR/>

            <!-- the email input field uses a HTML5 email type check -->
            <label for="login_input_email">Företagets Email</label><BR/>
            <input id="regUserEmail" class="login_input" type="email" name="business_email" required /><BR/><BR/>
